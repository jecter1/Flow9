...
public class Struct_EMul extends Struct {
	public Struct f_left;
	public Struct f_right;

	public Struct_EMul() {}
	public Struct_EMul(Struct a_left, Struct a_right) {
		f_left = a_left;
		f_right = a_right;
	}

	public int getTypeId() { return 17; }
	public String getTypeName() { return "EMul"; }
	...
	public void setFields(Object[] values) {
		if (values.length != 2)
			throw new IndexOutOfBoundsException("Invalid field count in EMul");
	...
	public int compareTo(Struct other_gen) {
		...
		Struct_EMul other = (Struct_EMul)other_gen;
